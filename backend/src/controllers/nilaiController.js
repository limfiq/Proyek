...
exports.getSummary = async (req, res) => {
    try {
        ...
        } else if (pendaftaran.tipe === 'MBKM' || pendaftaran.tipe === 'MBKM2') {
            // MBKM & MBKM 2: Logbook 25%, Monev 20%, Pembimbing 20%, Instansi 20%, Penguji 15%
...
exports.getRecap = async (req, res) => {
    try {
        ...
        const recap = pendaftarans.map(p => {
            ...
            } else if (p.tipe === 'MBKM' || p.tipe === 'MBKM2') {
